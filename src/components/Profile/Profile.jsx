        ...
        >
          <StyledForm>
            ...
            <LinkBox className="linkBox">
                <Instagram></Instagram>
              <LinkField className="linkInput" type="text" placeholder="Instagram" name="instagram"/>
              <Discord></Discord>
              <LinkField className="linkInput" type="text" placeholder="Discord" name="discord"/>
              <Telegram></Telegram>
              <LinkField className="linkInput" type="text" placeholder="Telegram" name="telegram"/>
              <Spotify></Spotify>
